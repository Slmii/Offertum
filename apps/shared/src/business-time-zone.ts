 ...
 * "which calendar day" decision (all-day calendar events, the quote PDF's printed dates,
 * user-facing date formatting in the web app) and every scheduled-job local time resolves
 * against this one zone.
 *
